        ...
        echo file_get_contents("EE_creation_success_page.html");
         ...
         //create MainObjectives TABLE
          $sql = "CREATE TABLE MainObjectives (
            ...
            $sql = "INSERT INTO MainObjectives (Title, Content, Creator) VALUES ('Example Title','Example Content','$UserName')";
            ...
            //create DepartObjectives TABLE
             $sql = "CREATE TABLE DepartObjectives (
               ...
               $sql = "INSERT INTO DepartObjectives (Title, Content, Creator, Department) VALUES ('Example Title','Example Content','$UserName','Production')";
               ...
               //create PersonalObjectives TABLE
                $sql = "CREATE TABLE PersonalObjectives (
                  ...
                  $sql = "INSERT INTO PersonalObjectives (Title, Content, Creator) VALUES ('Example Title','Example Content','$UserName')";
